/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4785de5bec84c362b7fbf439f8ea3fdb)
// Runtime types generated with workerd@1.20251001.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./entryPoint");
	}
	interface Env {
		KV: KVNamespace;
		AUTH_SECRET: string;
		NEXT_PUBLIC_API_DOCS_ENABLED: string;
		DATABASE: D1Database;
		WEBHOOKS: Queue;
		ASSETS: Fetcher;
	}
